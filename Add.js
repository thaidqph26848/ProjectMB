...
let URL = "http://192.168.1.40:3000/sanpham";
let URL_ADD = "http://192.168.1.40:3000/sanpham?_expand=cat";
...
const Add = ({ navigation }) => {
  ...
  const getDrop = () => {
    let url_api_drop = "http://192.168.1.40:3000/cats";
    fetch(url_api_drop)
      .then((res) => {
        return res.json();
      })
  ...
  const Update = () => {
    ...
    let url_pro = "http://192.168.1.40:3000/sanpham/" + id;
    ...
    const createTwoButtonAlert = () =>
      Alert.alert("Xoa sp", "Xóa san pham: " + item.ten_sp, [
        ...
        },
        {
          text: "OK",
          onPress: () => {
            let url_pro = "http://192.168.1.40:3000/sanpham/" + item.id;
      ...
      <View>
        <Modal visible={showModalDialog}>
          ...
          <View style={styles.Khung_dialog}>
            ...
            <View style={{ margin: 5 }} />
            <Button title="Thêm" onPress={SaveSP} />
          </View>
        </Modal>
      </View>
      <View>
        <Modal visible={showModalDialog2}>
          ...
          <View style={styles.Khung_dialog}>
            ...
            <View style={{ margin: 5 }} />
            <Button title="Sua" onPress={Update} />
            <View style={{ margin: 5 }} />
          </View>
        </Modal>
      </View>
